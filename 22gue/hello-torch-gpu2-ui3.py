...
def generate_text_stream(prompt, max_tokens=1000, max_context=512):
    ...
    try:
        ...
        for i in range(max_tokens):
            ...
            total_buffer_time += buffer_end - buffer_start
        ...
        print(f"Total buffering time: {total_buffer_time:.2f} seconds")
        print(f"Total garbage collection time: {total_gc_time:.2f} seconds")
